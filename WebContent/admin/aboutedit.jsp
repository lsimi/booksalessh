...
About about = (About)dao.findById(1,"About");
%>
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="aboutedit.action?id=1" method="post">
		        <label>联系人</label>
		        <input type="text" id="lxr" name="lxr" class="input-xlarge span12"  value="<%=about.getLxr() %>" required>
		        <label>电话</label>
		        <input type="text" id="tel" name=tel class="input-xlarge span12"  value="<%=about.getTel() %>" required>
		        <label>地址</label>
		        <input type="text" id="addr" name="addr" class="input-xlarge span12"  value="<%=about.getAddr() %>" required>
		        <label>内容</label>
		        <textarea id="editor_id" id="note" name="note" style="width:1000px;height:400px;" ><%=about.getNote() %></textarea>
