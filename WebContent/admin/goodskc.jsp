...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommonDAO dao = (CommonDAO)Info.getDao(request,"CommonDAO");
	 ...
	 String url = "/booksalessh/admin/goodskc.jsp?1=1";
...
<div class="well">
    <table class="table">
      ...
      <tbody>
      <%
      PageManager pageManager = PageManager.getPage("/booksalessh/admin/goodskc.jsp?1=1",10, request);
      ...
      for(Goods goods:list){
        ...
        <tr>
          ...
          <td>
		    ...
		    <font color="red">(该图书库存不足，请补仓)</font>
		    <%} %>
          </td>
          <td>
