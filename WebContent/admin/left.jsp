  ...
  if(admin.getUsertype().equals("管理员")){%>
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li><a href="admin/newslist.jsp">站内新闻</a></li>
...
<!-- <span class="label label-info">+3</span> -->
        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>商城业务<i class="icon-chevron-up"></i></a>
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li><a href="admin/protype.jsp">图书类别</a></li>
            <li><a href="admin/ppinfo.jsp">图书品牌</a></li>
            <li><a href="admin/goodsgl.jsp">图书管理</a></li>
            <li><a href="admin/goodskc.jsp">图书库存</a></li>
            <li><a href="admin/ddgl.jsp">订单管理</a></li>
            <li><a href="admin/thapplygl.jsp">退货申请</a></li>
        ...
        <ul id="tj-menu" class="nav nav-list collapse in">
            ...
            <li><a href="admin/tj6.jsp">进货量统计</a></li>
             <li><a href="admin/tj4.jsp">退货量分析</a></li>
            <li><a href="admin/tj5.jsp">收藏量分析</a></li>
            
        </ul> -->
    </div>
    <%}else{ %>
    <div class="sidebar-nav">
        <a href="#dashboard-menu" class="nav-header" data-toggle="collapse"><i class="icon-dashboard"></i>图书经手人功能<i class="icon-chevron-up"></i></a>
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="admin/index.jsp">Home</a></li>
            <li><a href="admin/goodsgl.jsp">图书管理</a></li>
            <li><a href="admin/ddglforuser.jsp">图书订单</a></li>
            <li><a href="admin/thapplygl.jsp">退货图书</a></li>
            <li><a href="admin/tj3.jsp">销量量统计</a></li>
            <li><a href="admin/tj4.jsp">退货量统计</a></li>
            <li><a href="admin/tj6.jsp">进货量统计</a></li>
        </ul>
    </div>
    <%} %>
