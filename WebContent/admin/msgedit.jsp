...
<html lang="en">
  ...
  Chat ct = (Chat)dao.findById(id,"Chat");
  %>
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="chatedit.action?id=<%=id %>" method="post">
		        <label>回复内容</label>
		        <input type="text" id="hfmsg" name="hfmsg" class="input-xlarge span12" value="<%=ct.getHfmsg() %>" required>
