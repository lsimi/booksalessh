...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="newsedit.action?id=<%=id %>" method="post" enctype="multipart/form-data">
		        <label>标题</label>
		        <input type="text" id="title" name="title" class="input-xlarge span12"  value="<%=news.getTitle() %>" required>
		        <label>图片</label>
		        <input type="file" id="upFile" name="upFile" class="input-xlarge">
		        <label>内容</label>
		        <textarea id="editor_id" id="note" name="note" style="width:1000px;height:400px;" ><%=news.getNote() %></textarea>
