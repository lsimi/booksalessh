...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommonDAO dao = (CommonDAO)Info.getDao(request,"CommonDAO");
	 String hql = " from News where 1=1 and type='新闻'  ";
	 String url = "/booksalessh/admin/newslist.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/newslist.jsp?f=f" method="post" class="form-inline">
						    ...
						    <button class="btn btn-primary" onclick="newsadd()" type="button"><i class="icon-plus"></i> 站内新闻</button>
						</form>	
					</div>  	
				</div>
...
<div class="well">
    <table class="table">
      ...
      <%String did = request.getParameter("did");
	   ...
	   PageManager pageManager = PageManager.getPage("/booksalessh/admin/newslist.jsp?1=1",10, request);
   	...
   	for(News news:list){
        ...
        <tr>
          ...
          <td>
              <a href="admin/newsedit.jsp?id=<%=news.getId() %>"><i class="icon-pencil"></i></a>
              <a href="admin/newslist.jsp?did=<%=news.getId() %>" ><i class="icon-remove"></i></a>
          </td>
        </tr>
        <%} %>
      </tbody>
