...
<html lang="en">
  ...
  <body class="">
	...
	Ppinfo ppinfo = (Ppinfo)dao.findById(id,"Ppinfo");
	%>
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="ppinfoEdit.action?id=<%=id %>" method="post">
		        <label>品牌名称</label>
		        <input type="text" id="ppname" name="ppname" class="input-xlarge span12" value="<%=ppinfo.getPpname() %>" required>
