...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommonDAO dao = (CommonDAO)Info.getDao(request,"CommonDAO");
	 ...
	 String url = "/booksalessh/admin/protype.jsp?1=1";
...
<div class="well">
   ...
   PageManager pageManager = PageManager.getPage("/booksalessh/admin/protype.jsp?1=1",10, request);
