...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="protypeEdit.action?id=<%=id %>" method="post">
		        <label>类别名称</label>
		        <input type="text" id="title" name="typename" class="input-xlarge span12" value="<%=protype.getTypename() %>" required>
