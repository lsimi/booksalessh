...
for(Goods gd:list){
	...
	ArrayList<Backgoods> numlist = (ArrayList<Backgoods>)dao.findByHql(" from Backgoods where goodid="+gd.getId());
	int a = 0;
	for(Backgoods backgoods:numlist){
		a+=Integer.valueOf(backgoods.getSl());
	}
...
<div class="row-fluid">
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">退货量分析</a>
