...
for(Goods gd:list){
	...
	ArrayList<Fav> numlist = (ArrayList<Fav>)dao.findByHql(" from Fav where goodid="+gd.getId());
	int a = 0;
	a = numlist.size();
...
<div class="row-fluid">
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">收藏量分析</a>
