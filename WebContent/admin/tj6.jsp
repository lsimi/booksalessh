...
for(Goods gd:list){
	...
	ArrayList<Kcrecord> numlist = (ArrayList<Kcrecord>)dao.findByHql(" from Kcrecord where  flag=null and type='in' and gid="+gd.getId());
	int a = 0;
	for(Kcrecord kcrecord:numlist){
		a+=Integer.valueOf(kcrecord.getHappennum());
	}
...
<div class="row-fluid">
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">进货量分析</a>
