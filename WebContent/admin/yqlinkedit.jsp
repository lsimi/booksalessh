...
Yqlink yqlink = (Yqlink)dao.findById(id,"Yqlink");
%>
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="yqlinkedit.action?id=<%=id %>" method="post">
		        <label>链接名称</label>
		        <input type="text" id="title" name="linkname" class="input-xlarge span12" value="<%=yqlink.getLinkname() %>" required>
		        <label>链接地址</label>
		        <input type="text" id="title" name="linkurl" class="input-xlarge span12" value="<%=yqlink.getLinkurl() %>" required>
