		...
		<div class="container">
			...
			<div class="register">
				<div class="register-but">
				   <form name="f1" action="memberReg.action" method="post">
				   <div class="register-top-grid">
						...
						<div class="input">
							...
							<input type="text" class="form-control" placeholder="用户名 :" name="uname" id="uname" onblur="validatorloginName()" required>
						</div>
